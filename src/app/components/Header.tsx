...
function Header({}: Props) {
  return (
    <div className="bg-zinc-600 min-h-screen   flex flex-col justify-between relative">
      ...
      <div className="flex flex-row items-center justify-between bg-gradient-to-b from-zinc-800/90 px-16 py-8 z-10">
      ...
      <div className="text-center flex flex-col items-center px-16 py-8 bg-gradient-to-t from-zinc-800/70  z-10">
        <h1 className="text-7xl font-bold text-gray-100 py-12">
          {dataHeader[2]}
        </h1>
        <div className="flex flex-row  w-full items-end ">
          <p className="font-semibold text-2xl text-gray-100 max-w-5xl text-center justify-center mx-auto translate-x-6">
            {dataHeader[3]}
          </p>
